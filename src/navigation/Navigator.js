...
import VideoEstimationScreen, {
	screenOptions as VideoEstimationScreenOptions,
} from '../video/VideoEstimationScreen';
import VideoOverviewScreen, {
	screenOptions as VideoOverviewScreenOptions,
} from '../video/VideoOverviewScreen';
import VideoOptionsScreen, {
	screenOptions as VideoOptionsScreenOptions,
...
export const VideoNavigator = () => {
	return (
		<VideoStackNavigator.Navigator
			initialRouteName="VideoEstimation"
